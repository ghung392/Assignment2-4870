...
namespace Assignment2_3.Controllers
{
    public class SocialWorkAttendancesController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "SocialWorkAttendanceId,Description")] SocialWorkAttendance socialWorkAttendance)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "SocialWorkAttendanceId,Description")] SocialWorkAttendance socialWorkAttendance)
        {
            if (ModelState.IsValid)
            {
