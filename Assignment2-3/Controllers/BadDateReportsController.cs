...
namespace Assignment2_3.Controllers
{
    ...
    public class BadDateReportsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "BadDateReportId,Description")] BadDateReport badDateReport)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "BadDateReportId,Description")] BadDateReport badDateReport)
        {
            if (ModelState.IsValid)
            {
