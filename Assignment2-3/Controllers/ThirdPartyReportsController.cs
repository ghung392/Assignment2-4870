...
namespace Assignment2_3.Controllers
{
    ...
    public class ThirdPartyReportsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "ThirdPartyReportId,Description")] ThirdPartyReport thirdPartyReport)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "ThirdPartyReportId,Description")] ThirdPartyReport thirdPartyReport)
        {
            if (ModelState.IsValid)
            {
