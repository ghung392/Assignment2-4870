...
namespace Assignment2_3.Controllers
{
    public class IncidentsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "IncidentId,Type")] Incident incident)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "IncidentId,Type")] Incident incident)
        {
            if (ModelState.IsValid)
            {
