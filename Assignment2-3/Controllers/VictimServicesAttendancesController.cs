...
namespace Assignment2_3.Controllers
{
    public class VictimServicesAttendancesController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "VictimServicesAttendanceId,Description")] VictimServicesAttendance victimServicesAttendance)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "VictimServicesAttendanceId,Description")] VictimServicesAttendance victimServicesAttendance)
        {
            if (ModelState.IsValid)
            {
