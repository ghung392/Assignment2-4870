...
namespace Assignment2_3.Controllers
{
    public class HospitalAttendedsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "HospitalAttendedId,Description")] HospitalAttended hospitalAttended)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "HospitalAttendedId,Description")] HospitalAttended hospitalAttended)
        {
            if (ModelState.IsValid)
            {
