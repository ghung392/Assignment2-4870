...
namespace Assignment2_3.Controllers
{
    public class PoliceAttendancesController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "PoliceAttendanceId,Description")] PoliceAttendance policeAttendance)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "PoliceAttendanceId,Description")] PoliceAttendance policeAttendance)
        {
            if (ModelState.IsValid)
            {
