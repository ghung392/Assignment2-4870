...
namespace Assignment2_3.Controllers
{
    ...
    public class ReferringHospitalsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "ReferringHospitalId,Description")] ReferringHospital referringHospital)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "ReferringHospitalId,Description")] ReferringHospital referringHospital)
        {
            if (ModelState.IsValid)
            {
