...
namespace Assignment2_3.Controllers
{
    public class HivMedsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "HivMedsId,Description")] HivMeds hivMeds)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "HivMedsId,Description")] HivMeds hivMeds)
        {
            if (ModelState.IsValid)
            {
